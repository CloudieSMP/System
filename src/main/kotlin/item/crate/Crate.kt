    ...
    fun create(type: CrateType): ItemStack {
        val crate = ItemStack(Material.PAPER).apply {
            editMeta { meta ->
                ...
                meta.persistentDataContainer.set(Keys.CRATE_TYPE, PersistentDataType.STRING, type.name)
            ...
            setData(DataComponentTypes.CONSUMABLE, Consumable.consumable().consumeSeconds(1f).hasConsumeParticles(false).build())
